...
- [NumPy](https://www.numpy.org/) >=2.0.1 - Spacewalk's test suite uses NumPy's statistical functions
- [Matplotlib](https://matplotlib.org/stable/index.html) >=3.9.2  - Spacewalks uses Matplotlib to make plots
...
\`\`\`
git clone https://github.com/https://github.com/kamwal/spacewalks.git
cd spacewalks
\`\`\`
